...
# <a name="HTML">**HTML**</a><a href="#TOP"><img src="./img/backward.png" width="20px" /></a>

## <a name="语义化">语义化及好处</a><a href="#TOP"><img src="./img/backward.png" width="20px" /></a>
...
## <a name="XHTML、HTML区别">XHTML、HTML区别</a><a href="#TOP"><img src="./img/backward.png" width="20px" /></a>
...
## <a name="HTML5新标签">[HTML5新标签](https://www.w3cschool.cn/html5/html5-new-element.html)</a><a href="#TOP"><img src="./img/backward.png" width="20px" /></a>
>
...
## <a name="HTML5 为什么只需要写">HTML5 为什么只需要写 \<!DOCTYPE HTML\></a><a href="#TOP"><img src="./img/backward.png" width="20px" /></a>

HTML5 不基于 SGML，因此不需要对DTD进行引用，但是需要doctype来规范浏览器的行为（让浏览器按照它们应该的方式来运行）

HTML4.01基于SGML,所以需要对DTD进行引用，才能告知浏览器文档所使用的文档类型。

## <a name="Doctype作用 标准模式、混杂模式区别">Doctype作用？标准模式、混杂模式区别</a><a href="#TOP"><img src="./img/backward.png" width="20px" /></a>
...
## <a name="渐进增强与优雅降级">渐进增强与优雅降级-----开发方式，设计理念</a><a href="#TOP"><img src="./img/backward.png" width="20px" /></a>
...
## <a name="块级元素、内联元素">块级元素、内联元素（行内元素、行内块级元素）</a><a href="#TOP"><img src="./img/backward.png" width="20px" /></a>
...
## <a name="HTML全局属性有哪些">HTML全局属性有哪些</a><a href="#TOP"><img src="./img/backward.png" width="20px" /></a>
...
## <a name="src和href的区别">src和href的区别</a><a href="#TOP"><img src="./img/backward.png" width="20px" /></a>
...
## <a name="浏览器内核、私有化前缀">浏览器内核、私有化前缀</a><a href="#TOP"><img src="./img/backward.png" width="20px" /></a>
...
## <a name="web存储">cookies、sessionStorage 、和 localStorage 的区别</a><a href="#TOP"><img src="./img/backward.png" width="20px" /></a>
...
## <a name="HTML5的离线储存">HTML5的离线储存</a><a href="#TOP"><img src="./img/backward.png" width="20px" /></a>
...
## <a name="iframe缺点">iframe缺点</a><a href="#TOP"><img src="./img/backward.png" width="20px" /></a>
...
## <a name="link标签属性">link标签属性</a><a href="#TOP"><img src="./img/backward.png" width="20px" /></a>
### <a name="网页标题引入图标">网页标题引入图标</a><a href="#TOP"><img src="./img/backward.png" width="20px" /></a>
>
...
### <a name="预加载页面资源prefetch、prefetch">预加载页面资源prefetch、prefetch</a><a href="#TOP"><img src="./img/backward.png" width="20px" /></a>
...
## <a name="base标签">base标签</a><a href="#TOP"><img src="./img/backward.png" width="20px" /></a>
>
...
## <a name="响应式设计-viewport">响应式设计-viewport</a><a href="#TOP"><img src="./img/backward.png" width="20px" /></a>
>
    什么是 Viewport?
    viewport 是用户网页的可视区域。
...
## <a name="meta标签属性">meta标签属性</a><a href="#TOP"><img src="./img/backward.png" width="20px" /></a>
...
## <a name="IE hack">IE hack</a><a href="#TOP"><img src="./img/backward.png" width="20px" /></a>
>
...
## <a name="aria与role">aria与role</a><a href="#TOP"><img src="./img/backward.png" width="20px" /></a>
>
...
## <a name="CSS和JS的位置会影响页面效率，为什么">CSS和JS的位置会影响页面效率，为什么？</a><a href="#TOP"><img src="./img/backward.png" width="20px" /></a>
...
## <a name="未使用自适应写的PC页面在手机上显示不全的问题">未使用自适应写的PC页面在手机上显示不全的问题</a><a href="#TOP"><img src="./img/backward.png" width="20px" /></a>
...
## <a name=""></a><a href="#TOP"><img src="./img/backward.png" width="20px" /></a>
## <a name=""></a><a href="#TOP"><img src="./img/backward.png" width="20px" /></a>
