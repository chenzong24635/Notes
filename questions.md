...
<details>
  ...
  * <a href="#手机号验证">手机号验证</a><br>
  * <a href="#邮箱验证">邮箱验证</a><br>
  * <a href="#密码验证">密码验证</a><br>
  * <a href="#保留小数点后两位-不足则补零">保留小数点后两位-不足则补零</a><br>
  * <a href="#浮点型+-*/">浮点型+-*/</a><br>
  * <a href="#时间戳、日期 的转换">时间戳、日期 的转换</a><br>
  * <a href="#浏览器判断">浏览器、手机类型判断navigator.userAgent</a><br>
  * <a href="#获取当前页面url网址信息">获取当前页面url网址信息</a><br>
  * <a href="#图片转base64">图片转base64</a><br>
  * <a href="#base64数据导出文件">base64数据导出文件，文件下载</a><br>
  * <a href="#判断字符串长度">判断字符串长度</a><br>
  * <a href="#0.1+0.2">0.1+0.2!=0.3 原因，解决</a><br>
  * <a href="#移动端点透问题">移动端点透问题(click 300ms延迟)</a><br>
  * <a href="#随机字符串">随机字符串</a><br>
  * <a href="#随机6个数字">随机6个数字</a><br>
  * <a href="#范围内随机数，包括两个数在内">范围内随机数</a><br>
  * <a href="#数字千分位">数字千分位</a><br>
  * <a href="#统计字符串中同一字符出现次数">统计字符串中同一字符出现次数</a><br>
  * <a href="#类数组转化为数组">类数组转化为数组</a><br>
  * <a href="#判断是否回文、实现回文">判断是否回文、实现回文</a><br>
  * <a href="#实现f(a)(b)与f(a,b)一样的效果">实现f(a)(b)与f(a,b)一样的效果</a><br>
  * <a href="#无限累加的函数 add">实现一个无限累加的函数add(1)(2)(3)...</a><br>
  * <a href="#数组无序排列">数组无序排列</a><br>
  * <a href="#数组扁平化">数组扁平化:n维数组展开成一维数组</a><br>
  * <a href="#数组去重">数组去重</a><br>
  * <a href="#数组排序">数组排序</a><br>
  * <a href="#n的阶层（尾调用优化）">n的阶层（尾调用优化）</a><br>
  * <a href="#斐波那契数列">斐波那契数列</a><br>

  * <a href="#unicode转中文">unicode转中文</a><br>
  * <a href="#取消选择，防止复制，禁止剪切、粘贴">取消选择，防止复制，禁止剪切、粘贴</a><br>
  * <a href="#网页是否可编辑">网页是否可编辑</a><br>
  * <a href="#逗号操作符">逗号操作符</a><br>


  * <a href="两位大整数相加">两位大整数相加</a><br>
  * <a href="#一道setTimeout面试题">一道setTimeout面试题</a><br>
  * <a href="#map(parseInt) 原理解析">['1','2','3'].map(parseInt) 原理解析</a><br>
  * <a href="#Array.apply(null,Array(3))与Array(3)区别">Array.apply(null,Array(3))与Array(3)区别</a><br>


  * <a href="#页面加载进度条">页面加载进度条</a><br>
  <a href="#"></a><br>
  <a href="#"></a><br>
...
## <a name="保留小数点后两位-不足则补零">保留小数点后两位-不足则补零</a><br>
>
...
## <a name="时间戳、日期 的转换">时间戳、日期 的转换</a><br>
...
## <a name="浏览器判断">浏览器、手机类型判断navigator.userAgent</a><br>
...
## <a name="获取当前页面url网址信息">获取当前页面url网址信息</a><br>
...
## <a name="图片转base64">图片转base64</a><br>
>
    getBase64(
...
## <a name="base64数据导出文件">base64数据导出文件，文件下载</a><br>
>
...
## <a name="判断字符串长度">判断字符串长度(英文占1个字符，中文汉字占2个字符)</a><br>
...
## <a name="0.1+0.2">0.1+0.2!=0.3</a><br>
* 解决：
>
    先升幂再降幂
...
## <a name="移动端点透问题">移动端点透问题(click 300ms延迟) </a><br>
...
## <a name="范围内随机数，包括两个数在内">范围内随机数</a><br>
>
    const number =(min, max) => Math.random() * (max - min) + min

## <a name="数字千分位">数字千分位 </a><br>
1. toLocaleString()
>   
    var a = 123456;
...
## <a name="统计字符串中同一字符出现次数">统计字符串中同一字符出现次数</a><br>
>
...
## <a name="判断是否回文、实现回文">判断是否回文、实现回文</a><br>
* 判断是否回文
>
...
## <a name="实现f(a)(b)与f(a,b)一样的效果">实现f(a)(b)与f(a,b)一样的效果</a><br>
...
## <a name="无限累加的函数 add">实现一个无限累加的函数add(1)(2)(3)...</a><br>
...
## <a name="数组扁平化">数组扁平化:n维数组展开成一维数组  </a><br>
...
## <a name="n的阶层（尾调用优化）">n的阶层（尾调用优化）</a><br>
1 1 2 3 5 8 13....
>
    //获取第n个斐波那契数列
...
##  <a name="自动触发onclick事件">自动触发onclick事件</a><br>
    if(document.all) { // IE
...
## <a name="unicode转中文">unicode转中文</a><br>
>
...
## <a name="取消选择，防止复制，禁止剪切、粘贴">取消选择，防止复制，禁止剪切、粘贴</a><br>
...
## <a name="一道setTimeout面试题">一道setTimeout面试题</a><br>
https://zhuanlan.zhihu.com/p/25407758

## <a name="map(parseInt) 原理解析">['1','2','3'].map(parseInt) 原理解析</a><br>
...
## <a name="比较两个对象是否相等">比较两个对象是否相等</a><br>
...
## <a name="Array.apply(null,Array(3))与Array(3)区别">Array.apply(null,Array(3))与Array(3)区别</a><br>
...
# 定义一个简单的模板类，使用{}作为转义标记，中间的数字表示替换目标，format实参用来替换模板内标记 
 >   
    ...
    // use
    (function () {
        var t = new fn('<p><a href="{0}">{1}</a><br><span>{2}</span></p>');
